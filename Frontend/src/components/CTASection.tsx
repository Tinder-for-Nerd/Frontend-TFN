      ...
      >
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
            <button className="flex items-center gap-1.5 rounded-xl bg-teal-600 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-teal-700">
              Create your profile
              <ArrowRight size={16} />
            </button>
            <button className="rounded-xl border border-gray-600 px-6 py-3 text-sm font-medium text-gray-300 transition-colors hover:border-gray-500 hover:text-white">
              Learn more
            </button>
          </div>
        </div>
