    ...
    <section id="events" className="bg-navy-900 px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          ...
          <button className="mt-4 flex shrink-0 items-center gap-1.5 rounded-xl border border-gray-600 px-4 py-2.5 text-sm font-medium text-gray-300 transition-colors hover:border-gray-500 hover:text-white sm:mt-0">
            View calendar
            <ArrowRight size={15} />
          </button>
        </div>
