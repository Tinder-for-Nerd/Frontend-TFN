...
export default function ProfileCard({ founder, index }: ProfileCardProps) {
  return (
    ...
    >
      ...
      <button onClick={() => toast.info(`Viewing ${founder.name}'s profile`)} className="mt-4 flex w-full items-center justify-center gap-1.5 rounded-xl border border-gray-300 bg-white px-4 py-2.5 text-sm font-medium text-navy-900 transition-colors hover:bg-gray-50 group-hover:border-teal-300 group-hover:text-teal-700">
        View profile
